...
public class MessageTag extends Number {
	public static final ubyte STRING_TAG = ubyte.valueOf(2);
	public static final ubyte INTEGER_TAG = ubyte.valueOf(3);
	public static final ubyte FLOAT_TAG = ubyte.valueOf(4);
	...
	public static ubyte[] encode(MessageTag msg) {
		...
		if (type == 2) {
			...
			int len = text.length();
			ubyte lo = ubyte.valueOf(len % 256);
			ubyte hi = ubyte.valueOf(len / 256);
			data.add(lo);
			data.add(hi);
