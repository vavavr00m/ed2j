...
public class LoginCall implements Callable<Boolean> {
	...
	public LoginCall(Socket socket, int port, long timeout,
	...
	public Boolean call() throws Exception {
		...
		try {
			...
			map.put("Server IP",
					ubyte.parseOneDArray(socket.getLocalAddress().getAddress()));
			map.put("Server Port", ubyte.parseOneDArray(Toolbox
					.int2Bytes(socket.getLocalPort())));
