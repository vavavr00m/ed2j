...
//		map.put("Nickname", nickname);
	...
	public ubyte[] encode(Map<String,Object> map) {
		...
		System.arraycopy((ubyte[])uh.getBytes(), 0, data, 7, 16);
		System.arraycopy((ubyte[])map.get("Client ID"), 0, data, 23, 4);
		System.arraycopy((ubyte[])map.get("Client Port"), 0, data, 27, 2);
		System.arraycopy((ubyte[])map.get("Server IP"), 0, data, 33, 4);
		System.arraycopy((ubyte[])map.get("Server Port"), 0, data, 37, 2);
		return data;
	}
